package fi.tieto.teco.demo.config.timezone;

import fi.tieto.teco.demo.AppApp;
import fi.tieto.teco.demo.config.SecurityBeanOverrideConfiguration;
import fi.tieto.teco.demo.repository.timezone.DateTimeWrapper;
import fi.tieto.teco.demo.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, AppApp.class})
