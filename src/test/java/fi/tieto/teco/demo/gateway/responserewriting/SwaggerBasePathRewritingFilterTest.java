package fi.tieto.teco.demo.gateway.responserewriting;
...
import static fi.tieto.teco.demo.gateway.responserewriting.SwaggerBasePathRewritingFilter.gzipData;
